      ...
      <div class="main">
          ...
          <div v-if="check ===  1 && themes" class="procedure">
            ...
            <div class="procedure-edit">
              <el-button class="procedure-edit-button" @click="isShow=!isShow">流程编辑</el-button>
              <div class="procedure-edit-frame" v-if="isShow">
                <h1 class="edit-header">编辑考核流程</h1> 
                <el-button type="danger" icon="el-icon-close" circle size="mini" class="close-button" @click="isShow=false"></el-button>
                <ul class="edit-stage">
                  <li v-for="(stage, index) in stages" :key="index"> {{ stage }} 
                    <i class="el-icon-remove-outline remove-button"></i>
                  </li>
                  <li><input type="text">
                    <i class="el-icon-circle-plus-outline remove-button"></i>
                  </li>
                </ul>
              </div>
            </div>
